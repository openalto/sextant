...
import org.opendaylight.yang.gen.v1.urn.alto.manual.maps.costmap.rev151021.cost.map.map.dst.costs.Cost;
import org.opendaylight.yang.gen.v1.urn.alto.manual.maps.costmap.rev151021.cost.map.map.dst.costs.cost.TypeNumerical;
import org.opendaylight.yang.gen.v1.urn.alto.manual.maps.costmap.rev151021.cost.map.map.dst.costs.cost.TypeOrdinal;
